...
const MaskedAbout = () => {
  ...
  // Smooth text movement while scrolling
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen bg-gray-900 text-white flex items-center justify-center px-6">
      {/* Background Gradient */}
      ...
      <div className="relative max-w-7xl w-full mx-auto px-6 lg:px-8">
        ...
        {/* Introduction */}
        <motion.p style={{ y: y2, opacity }} className="text-lg text-center leading-relaxed max-w-4xl mx-auto">
        ...
        <motion.div style={{ y: y3, opacity }} className="mt-8">
          ...
          <ul className="list-disc text-lg text-center space-y-2 max-w-4xl mx-auto">
